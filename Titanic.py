...
st.write(''' # Titanic survivors ''')
st.image("tt.jpg", caption="El Titanic navegaba desde Southampton, Inglaterra, hasta Nueva York en Estados Unidos.")
...
if prediction == 0:
  st.write('¡Te ahogaste mi chavo!')
elif prediction == 1:
  st.write('¡Lo lograste! ( DiCaprio no :( )')
else:
